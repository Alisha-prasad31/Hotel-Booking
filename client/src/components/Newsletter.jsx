...
const Newsletter = () => {
  return (
    ...
    <div className="flex flex-col items-center w-full max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto mt-20 bg-gray-900 text-white">
        <Title title="Stay Comfortable And Inspired" subTitle="Join our newsletter and be the first to discover new updates, exclusive offers, and inspiration."/>
